...
namespace Mvvm.Validation
{
	...
	public static class ValidationHelperExtensions
	{
        ...
        public static void AddMaxLengthRule(this ValidationHelper validator, Expression<Func<object>> propertyExpression, int length, string errorMessage)
        {
            ...
            validator.AddRule(propertyExpression, () =>
            {
                ...
                if (stringPropertyValue != null && stringPropertyValue.Length > length)
		...
		public static void AddChildValidatable(this ValidationHelper validator, Expression<Func<IValidatable>> childValidatableGetter)
		{
			...
			validator.AddAsyncRule(Common.PropertyName.For(childValidatableGetter), (Action<RuleResult> onCompleted) =>
			{
		...
		public static void AddChildValidatableCollection(this ValidationHelper validator, Expression<Func<IEnumerable<IValidatable>>> validatableCollectionGetter)
		{
			...
			validator.AddAsyncRule(Common.PropertyName.For(validatableCollectionGetter), (Action<RuleResult> onCompleted) =>
			{
				var items = getter();
